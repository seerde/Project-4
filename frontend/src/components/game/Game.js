    ...
    Sketch = (p) => {
        ...
        async function startGame() {
            if (isDrawing) {
                // get 3 random words
                try {
                    let wordsArry = await axios.get(`http://localhost:3001/api/word/${lang}/random/1/1/1`);
    ...
    render() {
        ...
        <button id="clear">Clear</button>
                    ...
                    <div className="colors__container">
                        ...
                        <div className="section">
                            <div id="width1" className="width color__box">5</div>
                            <div id="width2" className="width color__box">15</div>
                            <div id="width3" className="width color__box">25</div>
                        </div>
